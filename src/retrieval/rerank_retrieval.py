...
def build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(
        description="Unified Qwen3 reranking + evaluation CLI for QFR-RAG. Select task with --dataset.",
...
""",
    ...
    ap.add_argument(
        ...
        required=True,
        choices=["A", "B"],
        help="QFR task to rerank and evaluate: A (Task A chunk-level) or B (Task B slot-based).",
    )
...
def main() -> None:
    ...
    # Validate required corpus argument
